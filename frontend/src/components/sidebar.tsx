  ...
  return (
    <aside className="w-60 bg-white border-r border-gray-200 h-screen fixed left-0 top-0 flex flex-col">
      <div className="px-6 py-5 border-b border-gray-100">
        <h1 className="text-sm font-bold text-blue-700 tracking-tight">KoperasiKuat</h1>
        <p className="text-[10px] text-gray-400 uppercase tracking-wider mt-0.5">Stock Management</p>
      </div>
